...
public class SardineFaresApplication {
    ...
    CommandLineRunner commandLineRunner(FareRepository fareRepository) {
        return (env) -> {
            ...
            List<Fare> fares = Arrays.asList(new Fare("SA-100", date, new BigDecimal("101")), new Fare("SA-101", date, new BigDecimal("101")),
                    new Fare("SA-102", date, new BigDecimal("102")), new Fare("SA-103", date, new BigDecimal("103")),
                    new Fare("SA-104", date, new BigDecimal("104")), new Fare("SA-105", date, new BigDecimal("105")),
